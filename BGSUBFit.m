...
%
% Note: that by setting bgsub=0 BGSUBFit will do fitting without doing
...
% is standard for Matlab functions. e.g., 'bpthrsh',95 would set the
% parameter bpthrsh=95
%
%
%%%% Outputs %%%%
...
%
%%%% Dependencies %%%%
% AVGSUB_tiffs saveastiff TIFFStack Guessing bpass Mol_off_frames MLEwG
% gaussFit Subtract_then_fit Track_3D2 Tracking Track_filter hungarian
% ViewFits
%
%%%%
...
% name value pair (e.g., 'bpthrsh',95). Please see the user guide for
